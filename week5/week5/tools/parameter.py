...
parser = argparse.ArgumentParser(description="async design generator")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "async-gen":
    print('Error: Generator specification must be "async-gen".')
    sys.exit(1)
...
mFilePublic1 = genDir + args.platform + ".model_async"
